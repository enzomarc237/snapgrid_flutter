...
// Open XCode and edit MainFlutterWindow.swift to match the following code
...
// Set the backgroundColor to transparent on MacosApp, MacosWindow and MacosScaffold widgets